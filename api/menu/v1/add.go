...
type MenuAddReq struct {
	...
	Type          int    `v:"required|integer" d:"1" json:"type" dc:"类型 1菜单,2接口,3按钮,4目录"`
	Path          string `d:"" json:"path" dc:"路径"`
	Sort          int    `v:"required|integer" d:"10" json:"sort" dc:"排序"`
	...
	IsHidden      int    `v:"required|integer" d:"2" json:"is_hidden" dc:"是否隐藏 2:否 1:是"`
	...
	Link          string `d:"" json:"link" dc:"外部连接"`
