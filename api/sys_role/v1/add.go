 ...
 * @LastEditTime: 2025-07-01 20:55:46
...
type RoleAddReq struct {
	...
	RoleName string  `v:"required|length:1,100" d:"" json:"role_name" dc:"角色名称"`
	RoleCode string  `v:"required|length:1,100" d:"" json:"role_code" dc:"角色编码"`
	RoleDesc string  `d:"" json:"role_desc" dc:"备注"`
	Status   int     `v:"required|integer" d:"1" json:"status" dc:"状态 1-正常 2-禁用"`
	MenuIds  []int64 `v:"required" json:"menu_ids" dc:"菜单IDs"`
}
